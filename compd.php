		...
		<div class="container">
			<div class="row">
				...
				<!--	<h3 class=""><marquee style="background-color:grey;">procurement made faster and easier</marquee></h3> -->
						<img src="img/phones/generics.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="compb.php?product_id=13" method="post">
							<?php
