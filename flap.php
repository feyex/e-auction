		...
		<div class="container">
			<div class="row">
				...
				<!--	<h3 class=""><marquee style="background-color:grey;">procurement made faster and easier</marquee></h3> -->
						<img src="img/laptop.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="flap.php?product_id=18" method="post">
										<?php
											...
											if($row2['end_date'] < $date)
												...
												//	echo $end_date;
													...
													$time="<marquee><h3>".$days_rem."days ".$hours_rem."hours ".$min_rem."min ".$sec_rem."sec to bid closure"."</h3></marquee>";
						...
						//Check if all fields are not empty
										if($bid_amount >"5000")		
												...
												//	$query1= mysqli_query ($connection,$result1) or die (mysqli_error ($connection));
														...
														echo "<center><b><p><font color='blink'>Bid price too low!!  <br /> Bid incomplete </font></p> </b> </center>";
														}
					...
					?>
							<p><b><label name="name">NAME:  <?php echo $row1['name'];?></label></b></p>
                       		<p><b> Quantity:</b>20 </p>
					   		<p><b><label name="amount"> Lowest bid:<?php echo $row2['amount'];?></label></b></p>
