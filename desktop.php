 ...
 <?php
			 ...
			 session_start();
			  ...
			  ?>
				...
				?>
			<center>	Welcome <b><?php echo $_SESSION["username"]; ?>.</b> Click here to <a href="logout.php" tite="Logout"><b><em>Logout.</b></center>
				<?php
				}
				?>
			 </td>
       ...
       <section id="about" class="templatemo-section templatemo-top-130">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<img src="img/c.jpg" class="img-responsive img-bordered img-about" alt="about img">
						<center>
				...
				<?php
                                        	...
                                        	$sql = "select end_date,amount from product where product_id=8";
...
<?php
						if (isset($_POST['bid'])){
							...
							$sql1 = "select end_date from product where product_id=8";
											...
											if($row1['end_date'] < $date)
												{
													//echo "bid expired";
													//$end_date=$row['end_date'];
													header ("Location:bidreport2.php");
											...
											"</form>";		
													...
													header ("Location:deskc.php?product_id=8");
												}
						}
					...
					?>
							...
							<p><strong> Lowest Bid: <?php echo $amount;?></stong></p>
...
<!-- start gallery -->
	<section id="gallery" class="templatemo-section templatemo-light-gray-bg">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2 class="text-center text-uppercase"PRODUCT > DESKTOPS</h2>
					<hr>
				</div>
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						<img src="img/ind.jpg" class="img-responsive gallery-img" alt="realtch 1">
						<div class="gallery-des">
							<h3>MULTI-DEFINITION COMPLETE SYSTEMS </h3>
                            <h5>4GB RAM, 1TB HDD,core i5 processor</h5>
                         <a href="deskd.php?product_id=16">   <input type="submit" value="Bid Now"> </a>
						</div>
					</div>
				</div>	
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						<img src="img/g.jpg" class="img-responsive gallery-img" alt="realtch 2">
						<div class="gallery-des">
							<h3>DELL INSPIRON 453</h3>
						<a href="deske.php?product_id=5">	<h5><input type="submit" value="Bid Now"></h5></a>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						<img src="img/rt.jpg" class="img-responsive gallery-img" alt="realtch 3">
						<div class="gallery-des">
							<h3>HP High Definition Speakers </h3>
                            <h5></h5>
                         <a href="deskf.php?product_id=15">   <input type="submit" value="Bid Now"> </a>
						</div>
					</div>
