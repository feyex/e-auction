		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
						...
						<br>
						<br>
						<form action="vprint.php?product_id=6" method="post">
							<?php
											...
											if($row2['end_date'] < $date)
												{
													...
													$bid="<h3><marquee>". $days_rem."days ".$hours_rem."hours ".$min_rem."min ".$sec_rem."sec to bid closure"."</marquee></h3>";
													}
						...
						//Check if all fields are not empty
										if($bid_amount >"4000")		
												...
												//	$query1= mysqli_query ($connection,$result1) or die (mysqli_error ($connection));
														...
														echo "<center><b><p><font color='blink'>Bid price is too low!!  <br /> Bid incomplete </font></p> </b> </center>";
														}
