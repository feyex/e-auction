		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">					
						<img src="img/p.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="hprint.php?product_id=10" method="post">
							<?php
					...
					?>
							<p><b><label name="name">NAME:  <?php echo $row1['name'];?></label></b></p>
                       		<p><b> Quantity:</b>20 </p>
					   		<p><b><label name="amount">bid :$6000</label></b></p>
