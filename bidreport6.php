...
<!--end session-->
					...
					<!-- Banner -->
						<section id="admin">
							<div class="inner">
								<!-- Form -->
								<div class="column">
                                    <form action="bidreport6.php?product_id=17" method="post">
                    ...
                    <?php
							...
							$sql="select min(amount) as amount from bidding where product_id=17";
				...
				<div class="field half first">
					<p><b><label name="name" style="color:black;">WINNER IS:</label> <?php echo $row2['username'];?></b></p>
