...
<!--end session-->
					...
					<!-- Banner -->
						<section id="admin">
							<div class="inner">
								<!-- Form -->
								<div class="column">
                                    <form action="bidreport.php?product_id=1" method="post">
                    ...
                    <?php
                          ...
                          /*  $sql1 = "select *, (select min(amount),user_id from bidding where product_id = 1) as least from product where product_id =1";
                           ...
                           $sql = "set @p := 0";
						    $result=mysqli_query($connection,$sql) or die(mysqli_error($connection));
                                ...
                                if($result){
                                    $sql3 = "select * from (select *, (@p := @p + 1) as rank from (select product_id, user_id, min(amount) as topamount from bidding where product_id = $id  group by user_id order by topamount) as t1) as t2 where t2.user_id = $user_id";
                                    $query=mysqli_query($connection,$sql3) or die(mysqli_error($connection));
						...
						*/
							$sql="select min(amount) as amount from bidding where product_id=1";
