		...
		<div class="container">
			<div class="row">
				...
				<!--	<h3 class=""><marquee style="background-color:grey;">procurement made faster and easier</marquee></h3> -->
						<img src="img/ind.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="deskd.php?product_id=16" method="post">
							<?php
					...
					?>
							<p><b><label name="name">NAME:  <?php echo $row1['name'];?></label></b></p>
                               <p><b> Quantity:</b>10 </p>
                               <p><b> Lowest bid price:</b>$45000 </p>
