		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">				
						<img src="img/rt.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="deskf.php?product_id=15" method="post">
							<?php
					...
					?>
							<p><b><label name="name">NAME:  <?php echo $row1['name'];?></label></b></p>
                               <p><b> Quantity:</b>20 </p>
                               <p><b> Lowest bid price:</b>$69000 </p>
