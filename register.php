								...
								<div class="column">
										...
										<?php
											...
											$dbc=mysqli_select_db($connection,"project");
												...
												// check if it contains inly integers.
													...
													//MAKE THE QUERY
													$result="INSERT INTO user (username,password,companyname,phone_no,email,address,file_upload) VALUES ('$username','$password','$companyname','$phone_no','$email','$address','$file_upload')";
                                    ...
                                    <div class="field half first">
									 ...
									 <span class="error">* <?php echo $filEr; ?> </span>    
										...
										<ul class="actions">
											<li><input value="REGISTER"  class="button" type="submit" name="submit"></li>
                                        </ul>
									</form>
