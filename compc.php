		...
		<div class="container">
			<div class="row">
				...
				<!--	<h3 class=""><marquee style="background-color:grey;">procurement made faster and easier</marquee></h3> -->
						<img src="img/phones/generiv.jpg" class="img-responsive img-bordered img-about" alt="about img">
					</div>
				<div class="col-md-6 col-sm-6">
						<br>
						<br>
						<br>
						<form action="compc.php?product_id=12" method="post">
							<?php
