		...
		<div class="container">
			<div class="row">
				...
				<center> <h3> <p id="timer_value" > </p> </h3> </center>
					<h1 class="text-uppercase"><a href="product.php"></a></h1>
				</div>
				...
				<?php
                                        	...
                                        	$sql = "select end_date,amount from product where product_id=5";
...
header ("Location:dlap.php?product_id=5");
...
<?php
						if (isset($_POST['bid'])){
							...
							$sql1 = "select end_date from product where product_id=5";
											...
											if($row1['end_date'] < $date)
												{
													//echo "bid expired";
													//$end_date=$row['end_date'];
													header ("Location:bidreport5.php");
